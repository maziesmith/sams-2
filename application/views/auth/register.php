<div class="lc-block" id="l-register">
    <?php echo form_open("auth/register", array('id'=>'register-form', 'method'=>'POST')); ?>
        <div class="input-group m-b-20 form-group-validation">
        ...
        <div class="input-group m-b-20 form-group-validation">
            <span class="input-group-addon"><i class="zmdi zmdi-male"></i></span>
            <div class="fg-line">
                <?php echo form_input('retype_password', set_value('retype_password'), array('class'=>'form-control fg-input', 'placeholder'=>"Retype Password")) ?>
            </div>
        </div>
