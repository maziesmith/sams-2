        ...
        <div class="modal-content">
            <?php echo form_open("contacts/add", array('id'=>'add-new-contact-form', 'class'=>'m-t-25 card')); ?>
                ...
                <div class="modal-footer">
                    <?php echo form_button(array('name'=>'contacts_submit', 'id'=>'contacts_submit', 'type'=>'submit'), 'Add', 'class="btn btn-link"') ?>
                    <?php echo form_button('contacts_close', 'Close', 'class="btn btn-link" data-dismiss="modal"') ?>
                </div>
            <?php echo form_close() ?>
        </div>
    </div>
