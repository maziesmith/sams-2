                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="dtp-container fg-line">
                            <input type='text' name="export_start" class="form-control date-picker" placeholder="dd/mm/YYYY">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 m-b-25">
                        ...
                        <div class="dtp-container fg-line">
                            <input type='text' name="export_end" class="form-control date-picker" placeholder="dd/mm/YYYY">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <p class="f-500 c-black m-b-25">Select Level</p>
                        <select class="tag-select" data-placeholder="Choose a Country..." style="display: none;">
                    ...
                    <div class="col-sm-6 m-b-10">
                        <button id="export-btn" type="button"class="btn bgm-red waves-effect m-t-10"><i class="zmdi zmdi-case-download"></i> &nbsp; Export Now</button>
                    </div>
                </div>
            </div>
        </div>
