<div class="modal fade" id="edit-schedule" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-fluid">
        <div class="modal-content">

            <input id="schedule-edit-table-command-list" type="hidden" value="<?php echo base_url('schedules/listing') ?>">
            <input id="schedule-table-command-update-button" type="hidden" value="<?php echo base_url('schedules/update') ?>">
            <input id="schedules-table-command-update-button" type="hidden" value="<?php echo base_url('schedules/update') ?>">

            <?php echo form_open("schedules/update", array('id'=>'edit-schedule-form', 'class'=>'m-t-25 card', 'method'=>'POST'), array('id'=>'AJAX_CALL_ONLY')); ?>
                ...
                <div class="modal-footer">
                    <button type="submit" name="schedules_submit" class="btn btn-link">Update</button>
