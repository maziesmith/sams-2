...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
         ...
         **/
        templates: {
            actionButton: "<button class=\"btn btn-default btn-md\" type=\"button\" title=\"{{ctx.text}}\">{{ctx.content}}</button>",
            ...
            paginationItem: "<li class=\"{{ctx.css}}\"><a href='#' data-page=\"{{ctx.page}}\" class=\"{{css.paginationButton}}\">{{ctx.text}}</a></li>",
